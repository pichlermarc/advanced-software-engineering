...
const location1 = new Location(4711, "location1-dummy");
const location2 = new Location(4712, "location2-dummy");
const table1 = new Table(5811, "table1-dummy", location1.id);
const table2 = new Table(5812, "table2-dummy", location1.id);
const table3 = new Table(5813, "table3-dummy", location1.id);
const table4 = new Table(5814, "table4-dummy", location2.id);
const table5 = new Table(5815, "table5-dummy", location2.id);
