...
namespace RapidGuestRegistration.Client.Model
{
    ...
    public partial class Guest : IEquatable<Guest>, IValidatableObject
    {
        /// <summary>
        ...
        public Guest(string name = default(string), string email = default(string), string phoneNumber = default(string))
        {
            this.Name = name;
            this.Email = email;
        ...
        {
            return this.Equals(input as Guest);
        }

        /// <summary>
        /// Returns true if Guest instances are equal
        /// </summary>
        /// <param name="input">Instance of Guest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(Guest input)
        {
            if (input == null)
                return false;
